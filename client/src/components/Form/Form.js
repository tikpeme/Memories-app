...
const Form = ({currentId, setCurrentId}) =>{
    ...
    useEffect(() =>{  //accepts two parameters, a call back function and a dependencey array that determins when the call back function should be run, in this case, it's when the post value changes from nothing to actual post
